...
fun HeightSelectionScreen(
    ...
    var sliderValue by remember { mutableFloatStateOf(heightCm.toFloat()) }
    ...
    Column(
        ...
        Slider(
            ...
            onValueChange = {
                sliderValue = it
                viewModel.setHeightCm(it.toInt())
            },
        ...
        DotIndicator(total = 4, selectedIndex = 2)
